...
window.SUPPORT_CONFIG = {
  product: "this California CDL practice lab",
  cashapp: "",
  cryptoUrl: "",
  cryptoAddress: "",
  cryptoLabel: "BTC"
...
(function () {
  ...
  function render(el, variant) {
    ...
    const lead =
      variant === "result"
        ? "If this mock helped, chip in so the next driver can study for free."
    ...
    el.innerHTML =
      ...
      "<p>" +
      lead +
      " Cash App or crypto. This is a thank-you, not a tax-deductible donation, and not payment for a CDL.</p>" +
