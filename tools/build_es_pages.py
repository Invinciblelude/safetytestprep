...
def main() -> None:
    ...
    simple_page(
        ...
        [
            ...
            '<section class="price"><h2>Quiénes somos</h2><p>Safety Test Prep es un sitio educativo independiente en safetytestprep.com. Contacto: <a id="contact-mail" href="mailto:safetytestprep@gmail.com">safetytestprep@gmail.com</a>.</p></section>',
    ...
    simple_page(
        ...
        [
            ...
            '<section class="price"><h2>Pedir ayuda</h2><p>Si una página o un cuestionario es difícil de usar, escriba a <a id="contact-mail" href="mailto:safetytestprep@gmail.com">safetytestprep@gmail.com</a> con la URL y lo que necesita (por ejemplo texto más grande, una versión solo texto de una pregunta o un problema de teclado). Trabajaremos en un arreglo práctico.</p></section>',
